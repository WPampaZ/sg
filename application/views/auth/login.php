...
<head>
  ...
  <title>SistemaSDS | Iniciar Sesión</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url()?>"><b>Sistema</b>SDS</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url()?>index.php/auth/login_action" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" name="sign_in" class="btn btn-primary btn-block btn-flat">Registrarse</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
    ...
    <!---  a href="#">Olvidé mi contraseña<br -->
    <a href="<?php echo base_url()?>index.php/auth/register" class="text-center">Registrar una nueva membresía</a>
